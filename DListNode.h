...
typedef struct DListNode {
    ...
    struct DListNode *mNext;  /* Pointer to the next node in the list. NULL if this is the last node. */
    struct DListNode *mPrev;  /* Pointer to the prev node in the list. NULL if this is the last node. */
} DListNode;
